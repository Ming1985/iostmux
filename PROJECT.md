...
- [x] 用户输入接线 + PTY 尺寸协商 (2026-03-18) — 已在 Task 4 SessionView 中实现
- [x] 语音输入（Speech framework, 中英自动识别）(2026-03-18)
- [x] 手势键盘（底部上滑呼出，特殊键 + 快捷命令）(2026-03-18)
- [x] 断线重连（3 次自动重试 + 手动重连按钮）(2026-03-18)
- [x] 后台 Claude 空闲检测 + 本地通知 (2026-03-18)
- [>] 最终打磨 + 全设备测试
